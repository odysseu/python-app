...
function updateContent(translations) {
    if (translations) {
        ...
        const pdfFilenamePlaceHolderLabel = document.querySelector('label[for="pdf-filename"]');
        ...
        if (pdfFilenamePlaceHolderLabel) pdfFilenamePlaceHolderLabel.textContent = translations.pdfFilename;
